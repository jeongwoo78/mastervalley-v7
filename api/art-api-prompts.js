...
export const ORIENTAL_PROMPTS = {
  ...
  'minhwa': {
    ...
    prompt: `Korean folk painting (Minhwa) style from late Joseon Dynasty. MINERAL PIGMENTS on ROUGH THICK HANJI PAPER with PROMINENT FIBER TEXTURE visible throughout. GENUINELY FADED OLD colors like 200-year museum piece - BOLD Obangsaek palette (red, blue, yellow, white, black) but AGED and MUTED, not bright. UNEVEN PIGMENT ABSORPTION creating patchy color areas where paint pools in paper fibers. TREMBLING UNSTEADY thick black outlines - IRREGULAR and WOBBLY like amateur folk artist, not clean illustration. Applied in LAYERS from light to dark. SIMPLIFIED EXAGGERATED FORMS with humor and naive charm. Transform the ACTUAL SUBJECT of the photo into minhwa folk art style - preserve what is in the photo. Unconventional compositions filling entire surface. Authentic Joseon folk artifact quality. Traditional Korean hanbok clothing if people present. Skin painted in warm ochre and earth tones. Natural unadorned beauty - warm approachable charm with innocent smile.`
  },

  'minhwa_animal': {
    name: '민화 동물',
    nameEn: 'Korean Folk Painting Animal (Minhwa)',
    prompt: `Korean folk painting (Minhwa) animal portrait on ROUGH THICK HANJI PAPER with PROMINENT FIBER TEXTURE. TREMBLING UNSTEADY thick black ink outlines - IRREGULAR and WOBBLY with SOFT BLEEDING EDGES where ink seeps into hanji fibers. UNEVEN PIGMENT ABSORPTION with BARIM wash gradation where colors softly bleed at edges. OVERSIZED ROUND EYES with bright affectionate gaze, plump cheeks with upturned mouth corners, STUMPY ROUND PAWS, softly rounded chubby body. Paint the animal body in its ORIGINAL FUR COLOR from the photo rendered in muted aged mineral pigments. BACKGROUND AND DECORATIVE elements use SUBDUED EARTH-TONE palette - warm ochre-brown hanji tones. BLACK INK for outlines only. Yellow ONLY for eyes. Red ONLY as accent on nose and mouth. Green ONLY for pine needles. Pine tree, rocks, or simple natural elements as background. Animal markings rendered as DECORATIVE FOLK PATTERNS. Wobbly brushlines follow the animal's body contour. Flat even light across entire surface. Bold black claims all outlines, warm hanji beige claims background. Authentic Joseon folk artifact quality.`
  },
  ...
  'ukiyoe_animal': {
    ...
    prompt: `Japanese Ukiyo-e woodblock print in animal portrait style by Utagawa Kuniyoshi (歌川国芳). ADORABLE EXPRESSIVE ANIMAL as central subject drawn with irresistible charm and vivid personality. Bright sparkling eyes full of character, endearing facial expression. BOLD BLACK OUTLINES 3mm thick defining fur texture and body form with playful energy. Paint the animal in its ORIGINAL FUR COLOR rendered with water-soluble pigment texture. BACKGROUND uses LIMITED PALETTE - indigo (藍), vermillion (朱), yellow ochre, brown, grey. CHERRY WOOD BLOCK TEXTURE (桜板) visible in color areas. FLAT SOLID COLOR AREAS with subtle gradation for fur and features. Simple scenic background - garden, tatami room, or nature setting. Preserve the animal's NATURAL FORM, anatomy, and ORIGINAL FUR COLOR with charming expressive personality. Completely FLAT TWO-DIMENSIONAL Edo period aesthetic, heartwarming masterpiece.`
  },
...
export const ARTIST_STYLES = {
  ...
  'minhwa_animal': 'Korean folk painting (Minhwa) animal portrait on ROUGH THICK HANJI PAPER. TREMBLING WOBBLY thick black ink outlines with bleeding edges. Paint animal body in ORIGINAL FUR COLOR from photo. BACKGROUND uses SUBDUED EARTH-TONE palette - warm ochre-brown hanji tones. BLACK INK for outlines only. Oversized round eyes, plump cheeks, stumpy round paws, chubby body. Authentic Joseon folk artifact quality.',
  ...
  'ukiyoe_animal': 'Japanese Ukiyo-e woodblock print animal style by Utagawa Kuniyoshi. ADORABLE EXPRESSIVE animal as central subject, bold outlines, paint animal in ORIGINAL FUR COLOR. BACKGROUND uses limited palette. Edo period charming animal portrait.',
