...
export const ui = {
  category: {
    ...
    westernArtDesc: 'Uma viagem de 2.500 anos pela arte ocidental',
  ...
  photoStyle: {
    ...
    movementsFullTitle: 'Jornada Artística de 2.500 Anos',
    ...
    orientalFullDesc: 'Coreia · China · Japão',
    ...
    baroque: 'Barroco',
    rococo: 'Rococó',
    neoRomanReal: 'Neoclassicismo · Romantismo · Realismo',
  ...
  language: {
    ...
    sub: 'Mestres através dos séculos. Uma foto.',
