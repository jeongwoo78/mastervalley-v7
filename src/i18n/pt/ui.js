...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'Tentar novamente',
    retryConfirmBody: 'Tentar novamente {n} transformações falhadas? (grátis)',
    retryConfirmAction: 'Tentar novamente',
    retryCountExceeded: 'Limite de tentativas atingido (máx. 3)',
    cancel: 'Cancelar',
    ...
    loadingEducationFallback: 'A história desta obra será atualizada em breve.',
