...
export const orientalBasicInfo = {
  'korean': {
    loading: {
      ...
      subtitle2: 'Espírito capturado no espaço vazio'
    }
  },
  'chinese': {
    loading: {
      name: 'Pintura Tradicional Chinesa',
      subtitle1: 'Tinta e Aguada · Gongbi',
      subtitle2: 'O universo nos tons de tinta'
    }
  },
  'japanese': {
    loading: {
      ...
      subtitle2: 'Gravuras de rua e arte decorativa dourada'
    }
  },
  ...
  'chinese-gongbi': {
    result: {
      name: 'Pintura Tradicional Chinesa',
      subtitle1: 'Gongbi',
      subtitle2: 'Precisão criada com o pincel'
    }
  },
  'chinese-ink': {
    result: {
      name: 'Pintura Tradicional Chinesa',
      subtitle1: 'Pintura de Tinta e Aguada',
  ...
  'japanese-rinpa': {
    result: {
      name: 'Pintura Tradicional Japonesa',
      subtitle1: 'Rinpa',
      subtitle2: 'Beleza decorativa florescendo sobre folha de ouro'
    }
  }
};
...
export const orientalLoadingEducation = {
  ...
  korean: {
    description: `Os pintores coreanos aprenderam a técnica chinesa do pincel, mas pintaram a sua própria terra e o seu próprio povo.\nO Minhwa desejou sorte através de pias e tigres; o Pungsokdo capturou o quotidiano do povo comum.\nO Jingyeong Sansuhwa retratou não paisagens idealizadas, mas as montanhas e rios reais diante dos olhos do pintor.\n\nO espaço vazio fala, e o espírito flui pela ponta do pincel — esta é a arte da pintura tradicional coreana.\nDesejos, vida quotidiana e paisagens capturadas pelo pincel — conheça a pintura coreana, florescida do seu próprio solo.`
  },
  ...
  japanese: {
    description: `Nas ruas de Edo, as gravuras em madeira floresceram; nas cortes de Quioto, a pintura decorativa desabrochou.\nO Ukiyo-e esculpiu atores, belezas e paisagens em blocos de madeira vendidos ao povo comum.\nO Rinpa pintou íris e deuses do vento sobre folha de ouro, cativando os olhos da aristocracia.\n\nSensibilidade popular e esplendor cortesão coexistindo — esta é a arte da pintura tradicional japonesa.\nNascida em ruas e cortes, cruzando o oceano — conheça a pintura japonesa que sacudiu o mundo da arte ocidental.`
  }
};
...
export const orientalResultEducation = {
  ...
  'japanese_default': {
    description: `Os contornos tradicionais japoneses e os planos de cor decorativos foram aplicados à sua imagem.\nContornos ousados e coloração esplêndida sobre folha de ouro capturam a beleza de formas distintas.\n\nGravuras nascidas da cultura popular de Edo e a pintura decorativa da corte coexistem na arte japonesa.\nNascida em ruas e cortes, cruzando o oceano — a pintura japonesa que sacudiu o mundo da arte ocidental.`
  }
};
