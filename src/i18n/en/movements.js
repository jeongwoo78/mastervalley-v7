...
export const movementsBasicInfo = {
  ...
  'ancient': {
    loading: {
      ...
      subtitle1: 'Greek Sculpture · Roman Mosaic',
      subtitle2: 'Ideal beauty of gods and heroes'
    }
  },
  'medieval': {
    loading: {
  ...
  'renaissance': {
    loading: {
      ...
      subtitle2: 'Seeing anew through human eyes'
    }
  },
  'baroque': {
    loading: {
      ...
      subtitle2: 'Drama of light and shadow'
    }
  },
  'rococo': {
    loading: {
  ...
  'neoclassicism_vs_romanticism_vs_realism': {
    loading: {
      name: 'Neoclassicism · Romanticism · Realism (18th–19th Century)',
      subtitle1: 'David · Delacroix · Courbet',
      subtitle2: 'Reason, emotion, reality diverge'
    }
  },
  'impressionism': {
    loading: {
      ...
      subtitle2: 'The moment light becomes color'
    }
  },
  'postImpressionism': {
    loading: {
      ...
      subtitle2: 'Beyond light, into the soul'
    }
  },
  'fauvism': {
    loading: {
      ...
      subtitle2: 'Beasts who liberated color'
    }
  },
  'expressionism': {
    loading: {
      ...
      subtitle2: 'Painting what is felt'
    }
  },
  'modernism': {
    loading: {
      name: 'Modernism (20th Century)',
      subtitle1: 'Picasso · Magritte · Chagall',
      subtitle2: 'Breaking all the rules'
    }
  },
  ...
  'classical-sculpture': {
    result: {
      name: 'Ancient Greek & Roman (BC 800–AD 500)',
      subtitle1: 'Greek Sculpture',
      subtitle2: 'Where perfect proportion began'
    }
  },
  'roman-mosaic': {
    result: {
  ...
  'byzantine': {
    result: {
      name: 'Medieval Art (4th–14th Century)',
      subtitle1: 'Byzantine',
      subtitle2: 'Golden realm of the divine'
    }
  },
  'gothic': {
    result: {
      name: 'Medieval Art (4th–14th Century)',
      subtitle1: 'Gothic',
      subtitle2: 'Heaven built of light'
    }
  },
  'islamic-miniature': {
    result: {
  ...
  'leonardo': {
    result: {
      ...
      subtitle2: 'Where science meets art'
    }
  },
  'michelangelo': {
    result: {
  ...
  'botticelli': {
    result: {
      ...
      subtitle2: 'Poet who sang beauty'
    }
  },
  'titian': {
    result: {
  ...
  'rembrandt': {
    result: {
      name: 'Baroque (17th Century)',
      subtitle1: 'Rembrandt',
      subtitle2: 'Illuminating souls with light'
    }
  },
  'velazquez': {
    result: {
  ...
  'rubens': {
    result: {
      name: 'Baroque (17th Century)',
      subtitle1: 'Rubens',
      subtitle2: 'Master of motion and abundance'
    }
  },
  ...
  'watteau': {
    result: {
      name: 'Rococo (18th Century)',
      subtitle1: 'Watteau',
      subtitle2: 'Where dreamlike fêtes began'
    }
  },
  'boucher': {
    result: {
  ...
  'ingres': {
    result: {
      ...
      subtitle2: 'Pursuing perfect line'
    }
  },
  'delacroix': {
    result: {
  ...
  'manet': {
    result: {
      ...
      subtitle2: 'Opening the door to modern art'
    }
  },
  ...
  'degas': {
    result: {
      ...
      subtitle2: 'Capturing fleeting motion'
    }
  },
  'caillebotte': {
    result: {
      ...
      subtitle2: 'Recording Parisian daily life'
    }
  },
  ...
  'cezanne': {
    result: {
      ...
      subtitle2: 'Building nature in structure'
    }
  },
  'gauguin': {
    result: {
      ...
      subtitle2: 'Leaving civilization for the primitive'
    }
  },
  ...
  'vlaminck': {
    result: {
      ...
      subtitle2: 'Color unleashed by instinct'
    }
  },
  ...
  'kokoschka': {
    result: {
      ...
      subtitle2: 'Portrait as psychological battleground'
    }
  },
  ...
  'magritte': {
    result: {
      ...
      subtitle2: 'The trap of what is seen'
    }
  },
  'chagall': {
    result: {
...
// ========== Loading Education: Art Movement Introductions ==========
export const movementsLoadingEducation = {
  // ===== Ancient — Greek & Roman =====
  'ancient': {
    name: 'Ancient Greek & Roman',
    description: `Art pursuing the ideal beauty of gods and heroes was born in the Mediterranean.
Greek sculpture achieved the ideal human form through the golden ratio and contrapposto.
Roman mosaics arranged thousands of colored stones to depict myths and daily life.

Perfect proportion and balance — the foundation of 2,000 years of Western art begins here.
Rediscovered in the Renaissance, it became the standard for all Western art that followed.`
  },

  // ===== Medieval =====
  'medieval': {
    name: 'Medieval Art',
    description: `From the 4th to 14th century, European churches and Middle Eastern mosques overflowed with gold and sacred ornamentation.
...
A thousand years of aesthetics where faith and decoration became one.`
  ...
  'renaissance': {
    name: 'Renaissance',
    description: `In 14th-century Italy, a new exploration of humanity and nature began.
Da Vinci created mysterious shadows with sfumato, Michelangelo embodied heroic human forms.
...
A cultural rebirth beyond the Middle Ages — the era when humanity began to see the world anew.`
  ...
  'baroque': {
    name: 'Baroque',
    description: `In the 17th century, amid the upheaval of the Reformation, dramatic light and shadow dominated the canvas.
...
Art born of an era of religion and power, where emotion and drama exploded.`
  ...
  'rococo': {
    name: 'Rococo',
    description: `In the 18th century, elegant aristocratic pleasures flourished around the Palace of Versailles.
...
The final golden age of aristocratic culture, just before the French Revolution.`
  ...
  'neoclassicism_vs_romanticism_vs_realism': {
    ...
    description: `In the late 18th century, an era of fierce collision between reason, emotion, and reality began.
...
All experiments in 20th-century modern art began with them.`
  },

  // ===== Fauvism =====
  'fauvism': {
    name: 'Fauvism',
    description: `At the 1905 Paris Salon, the criticism "like a cage of wild beasts" became their name.
Matisse with bold pure colors, Derain and Vlaminck with explosive primary colors shattered tradition.
Paint squeezed straight from the tube roared on the canvas.

Color over form, emotion over depiction — a revolution where color itself became the protagonist.
Brief but intense, this movement opened the doors to Expressionism and abstract art.`
  },

  // ===== Expressionism =====
  'expressionism': {
    name: 'Expressionism',
    description: `In the early 20th century, inner anxiety and solitude poured onto the canvas.
Munch painted existential terror, Kirchner urban alienation, Kokoschka the turmoil of the soul.
...
Art of the soul, born in the shadow of two World Wars.`
  ...
  'modernism': {
    name: 'Modernism',
    description: `In the 20th century, tradition was shattered and new artistic experiments exploded.
Picasso deconstructed form, Miró played with symbols, Magritte inverted reality.
...
// ========== Result Education: Individual Styles/Artists ==========
export const movementsResultEducation = {
  // ===== Ancient — Greek & Roman =====
  'classical-sculpture': {
    name: 'Greek Sculpture',
    description: `The sculptural beauty and marble texture of ancient Greek sculpture have been applied.
...
The essence of ancient decorative art, where each stone carries the touch of a craftsman.`
  ...
  'byzantine': {
    name: 'Byzantine',
    description: `Byzantine golden mosaics and sacred frontality have been applied.
...
Golden religious art that deeply influenced Russian icons and Western European medieval art.`
  ...
  'gothic': {
    name: 'Gothic',
    description: `Gothic vertical ascension and the magic of light have been applied.
...
A glass textbook that taught the Bible to illiterate believers, and the mystery of light itself.`
  ...
  'islamic-miniature': {
    ...
    description: `The delicate brushwork and courtly elegance of Islamic miniatures have been applied.
...
A master of Spain\'s Golden Age, said to have painted even the air with a single brushstroke.`
  ...
  'rubens': {
    name: 'Rubens',
    description: `Rubens' abundant vitality and dynamic energy have been applied.
...
A painter of revolution who recorded history in paint, from the French Revolution to Napoleon.`
  ...
  'ingres': {
    name: 'Ingres',
    description: `Ingres' smooth outlines and porcelain-like texture have been applied.
