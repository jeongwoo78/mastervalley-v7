...
export const ui = {
  ...
  result: {
    ...
    recoveringResult: 'Recovering result...',
    retryConfirmTitle: 'Retry',
    retryConfirmBody: 'Retry {n} failed transformations? (free)',
    retryConfirmAction: 'Retry',
    retryCountExceeded: 'Retry limit exceeded (max 3 attempts)',
    cancel: 'Cancel',
