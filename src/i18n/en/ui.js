...
export const ui = {
  ...
  category: {
    ...
    westernArtDesc: '2800 Years of Western Art',
  ...
  photoStyle: {
    ...
    movementsFullTransformLabel: 'All 11 movements',
    mastersFullTransformLabel: 'All 7 masters',
    orientalFullTransformLabel: 'All East Asian styles',
    movementsFullTitle: 'Traveling 2800 years of art',
    ...
    baroque: 'Baroque',
    rococo: 'Rococo',
    neoRomanReal: 'Neo · Romantic · Realism',
    ...
    artNotice: 'Due to the nature of original masterworks, some styles may include artistic nudity.',
    nudeWarningSingle: 'Artistic nudity from the original work may be reflected in the result.',
    nudeWarningOneclick: 'Some results may reflect artistic nudity from the original works.',
  ...
  processing: {
    ...
    masterInProgress: 'master at work...',
    checkingArtwork: 'Checking artwork...',
    done: 'Done!',
    movementsComplete: 'movements master\'s work complete!',
    mastersComplete: 'masters\' work complete!',
    nationsComplete: 'nations master\'s work complete!',
    fullTransform: '✨ Full Transform',
    ...
    doneLabel: 'work done',
    masterDoneLabel: 'master\'s work done',
    ...
    orientalSub1: 'China · Japan · Korea',
  ...
  result: {
    ...
    aiRetrying: 'The master is retrying...',
    refreshButton: 'Refresh',
    refreshFailed: 'Could not load result',
    refreshing: 'Loading...',
    refreshInProgress: 'Still processing. Please try again in a moment.',
    retryLimitExceeded: 'Retry limit exceeded (max 3)',
    retryServerError: 'Retry server error. Please contact support.',
    retryUnauthorized: 'Retry not authorized.',
