...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'ลองใหม่',
    retryConfirmBody: 'ลองแปลงใหม่อีก {n} รายการที่ล้มเหลว? (ฟรี)',
    retryConfirmAction: 'ลองใหม่',
    retryCountExceeded: 'เกินจำนวนครั้งที่ลองใหม่ได้ (สูงสุด 3 ครั้ง)',
    cancel: 'ยกเลิก',
  ...
  // ===== AI Consent =====
  aiConsent: {
    message: 'รูปภาพของคุณจะถูกส่งไปยัง Replicate และ Anthropic เพื่อการแปลง AI และจะไม่ถูกเก็บรักษาหลังการประมวลผล',
    confirm: 'ตกลง'
  },
