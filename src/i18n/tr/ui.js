...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'Tekrar dene',
    retryConfirmBody: 'Başarısız {n} dönüşümü tekrar dene? (ücretsiz)',
    retryConfirmAction: 'Tekrar dene',
    retryCountExceeded: 'Tekrar deneme limiti aşıldı (en fazla 3)',
    cancel: 'İptal',
