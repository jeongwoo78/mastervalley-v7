...
export const ui = {
  ...
  photoStyle: {
    ...
    orientalName: '東洋畫',
    fullTransform: '全部轉換',
    movementsFullTransformLabel: '11個風格全部轉換',
    mastersFullTransformLabel: '7位大師全部轉換',
    orientalFullTransformLabel: '東方畫全部轉換',
    movementsFullTitle: '2800年藝術之旅',
    movementsFullDesc: '11個流派',
    mastersFullTitle: '7位大師的世界',
    mastersFullDesc: '與7位大師相遇',
    orientalFullTitle: '東方千年美學',
    orientalFullDesc: '中國・日本・韓國',
    perTransform: '轉換',
    ...
    chineseSub: '水墨畫・工筆畫',
    japaneseSub: '浮世繪・琳派',
    artNotice: '因名畫原作之特性，部分風格可能包含藝術性裸體。',
    nudeWarningSingle: '轉換結果可能反映原作中包含的藝術性裸體。',
    nudeWarningOneclick: '部分轉換結果可能反映原作中包含的藝術性裸體。',
  ...
  processing: {
    ...
    movementsComplete: '個流派大師作品完成！',
    mastersComplete: '位大師作品完成！',
    nationsComplete: '國東方繪畫大師作品完成！',
    fullTransform: '✨ 全部轉換',
    processingTitle: '處理中',
    tapToView: '點擊查看完成結果',
    error: '錯誤',
    ...
    orientalSub1: '中國・日本・韓國',
    orientalSub2: '相似卻各異的三國美學',
    prev: '◀ 上一個',
    next: '下一個 ▶',
    downloading: '下載中...'
  },
  ...
  result: {
    ...
    retryConfirmTitle: '重試',
    retryConfirmBody: '重新轉換{n}個失敗項目（免費）',
    retryConfirmAction: '重試',
    retryCountExceeded: '已超過重試上限（最多3次）',
    cancel: '取消',
    ...
    loadingEducationFallback: '關於此作品的故事即將更新。',
  ...
  gallery: {
    ...
    saved: '已儲存',
    empty: '尚無已儲存的圖片',
    emptySubtext: '轉換的照片會自動儲存於此',
    saveShare: '儲存/分享',
    save: '儲存',
    share: '分享',
    close: '關閉',
    confirmDelete: '要刪除此圖片嗎？',
    confirmDeleteAll: '要刪除所有圖片嗎？\n此操作無法復原。',
    savedToGallery: '已儲存至相簿！',
    savedToFiles: '已儲存！\nDocuments → MasterValley',
    saveFailed: '儲存失敗',
    shareTitle: 'Master Valley 作品',
    shareText: '來看看我用Master Valley製作的AI名畫！',
    linkCopied: '連結已複製到剪貼簿！',
    loading: '載入相簿中...',
    back: '返回',
    home: '首頁',
    ...
    deleteSelected: '刪除已選',
    cancel: '取消',
    confirmDeleteSelected: '要刪除已選的{count}張圖片嗎？',
    selectedCount: '已選{count}張',
    saving: '儲存中...',
    batchSaveComplete: '{count}張圖片儲存完成！',
    batchSavePartial: '{success}張成功，{fail}張失敗'
  },
