...
〈吶喊〉是存在主義恐懼的視覺表達，已成為藝術史上最具標誌性的圖像之一。` },
  'matisse': {
    name: '馬諦斯', description: `簡化的形態與大膽的原色已被應用。
...
她143幅畫作中，大多數是自畫像。「我畫自己，因為我時常孤獨，」她說。` },
  'lichtenstein': {
    name: '乃乞登斯坦', description: `使用印刷漫畫本戴點、粗黑輪廓與原色的普普藝術技法已被應用。
