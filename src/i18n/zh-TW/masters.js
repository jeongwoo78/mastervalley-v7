...
export const mastersLoadingEducation = {
  'vangogh': { description: `他被畫廊解僱，放棄了神學，傳教士申請也遭拒。\n文森·梵谷的人生始於一連串的失敗。\n他在27歲決定成為畫家，只活了十年。\n\n在那十年裡，他以狂熱的筆觸和燃燒的色彩，將內心傾注於畫布。\n他留下超過900幅油畫和1,100幅素描，生前卻只賣出一幅作品。` },
  'klimt': { description: `古斯塔夫·克林姆是在金箔上描繪愛與死的藝術家。\n他裝飾性的作品在世紀末的維也納引發醜聞，但他從未妥協。\n他在畫布上貼上真正的金箔，融入拜占庭馬賽克的美學。\n\n女性的官能與金色光輝交融，創造出夢幻的世界。\n雕刻師之子成為維也納藝術界的叛逆者，畫出自己的頹廢美學。` },
  'munch': { description: `他5歲失去母親，14歲失去心愛的姐姐。\n對愛德華·孟克而言，死亡不是遙遠的概念，而是永遠伴隨的陰影。\n他將那份焦慮與孤獨轉化為圖像，創造了全新的藝術語言。\n\n他將看不見的情感——恐懼、孤獨、焦慮——直接傾注於畫布。\n一位將終身的傷痕化為終身藝術的畫家。` },
  'matisse': { description: `亨利·馬諦斯在20歲做闌尾手術療養時發現了繪畫。\n他放棄法律轉向色彩——對藝術家來說是不尋常的起點。\n在1905年秋季沙龍上，「野獸」的批評成了運動的名稱。\n\n即使在晚年被限制在輪椅上，他仍以剪紙持續創作。\n一位從未停止創作、將色彩從模仿現實的義務中解放的藝術家。` },
  'chagall': { description: `馬克·夏卡爾出生在白俄羅斯小鎮維捷布斯克，他在那裡找到了一生所有的色彩。\n對貝拉的愛、村莊的屋頂、山羊和小提琴——一切都一起飛上了畫布。\n不屬於任何藝術運動，他以完全的自由描繪自己夢的世界。\n\n被俄國革命逐出故土，他成為流浪的猶太人。\n活了97歲，畫了一輩子愛、家園和永不熄滅的記憶的鄉愁畫家。` },
  'picasso': { description: `13歲時，巴勃羅·畢卡索的畫技已經超越了身為美術教師的父親。\n他掌握了學院派後又親手將其摧毀——挑釁與重新發明是他事業的核心。\n藍色時期、玫瑰時期、立體派、古典主義、超現實主義——他不斷重新發明自己。\n\n格爾尼卡，在六週的憤怒中完成，成為二十世紀的反戰宣言。\n91年人生留下超過50,000件作品；他的名字就是現代藝術的同義詞。` },
  'frida': { description: `18歲時，芙烈達·卡蘿遭遇一場可怕的公車事故，脊椎和骨盆粉碎。\n她在病床上開始作畫，注視著安裝在天花板上的鏡子——自畫像作為靈魂之鏡由此誕生。\n她嫁給壁畫家乃戈·乃維拉；他們離婚後又復婚，畫出充滿激情與風暴的愛情。\n\n她一生承受了32次手術，但從未停止作畫。\n一位將痛苦化為身分認同的藝術家：「腳啊，我要你做什麼，我有翅膀可以飛。」` },
  'lichtenstein': { description: `1961年，羅伊·乃乞登斯坦畫了米老鼠的漫畫，藝術界震動了。\n「這真的是藝術嗎？」——這個問題本身就是他的答案。\n他將印刷漫畫的本戴點放大到紀念碑般的尺度，藝術與流行文化之間的界線消失了。\n\n與沃荷一起，他將普普藝術推到藝術的最前線。\n一位證明了一格漫畫可以改變藝術史的藝術家。` }
};
...
export const mastersResultEducation = {
  ...
  'vangogh-selfportrait': { description: `梵谷自畫像的短促筆觸與螺旋背景已被應用。\n冷色調與旋轉的筆觸營造出心理緊張的氛圍。\n\n超過35幅自畫像，每一幅都是不同情緒狀態的鏡子。\n藝術史上最誠實、最赤裸的視覺日記。` },
  'klimt-kiss': { description: `吻的金色馬賽克與幾何圖案已被應用。\n真正的金箔與裝飾形態將這對戀人包裹在親密的繭中。\n\n螺旋與三角形交織纏繞，拜占庭裝飾與愛的狂喜融為一體。\n克林姆的傑作，金色永恆了愛的瞬間。` },
  'klimt-judith': { description: `乞蒂一世的金色與肌膚對比、挑戰的凝視已被應用。\n金箔與裸露的肌膚對峙，表現權力與官能。\n\n聖經女英雄以半闔的眼睛凝視觀者，帶著曖昧的微笑握著荷羅芬尼斯的頭。\n挑戰世紀末維也納禁忌、融合神聖與情色的作品。` },
  'klimt-treeoflife': { description: `生命之樹的韻律螺旋與裝飾馬賽克已被應用。\n螺旋分枝的樹木以象徵生命循環的圖案填滿空間。\n\n無盡的螺旋、花朵和眼睛交織，作為誕生、生命和死亡的隱喻。\n克林姆生命哲學的象徵，裝飾成為宇宙。` },
  'munch-scream': { description: `吶喊的紅色波浪天空與扭曲變形已被應用。\n波浪線條主導天空與地景，將焦慮傳染至整個環境。\n\n橋樑在強制透視中延伸，骨架般的人物雙手抱頭無聲尖叫。\n存在焦慮的至高圖標，源於孟克親身經歷的恐慌發作。` },
  'munch-madonna': { description: `聖母的曲線與陰暗光環已被應用。\n環繞裸體的紅色波浪表現神秘的官能。\n\n光環非神聖而是官能的，曲線同時喚起狂喜與痛苦。\n孟克將聖潔與無常融合、挑戰一切慣例的作品。` },
  ...
  'matisse-redroom': { description: `紅色房間的全面色彩與裝飾圖案已被應用。\n一片紅色主導空間，溶解了牆壁與桌面的界線。\n\n阿拉伯花紋如壁紙般重複，創造出扁平包裹的世界。\n馬諦斯證明色彩可以不靠透視法創造空間的作品。` },
  ...
  'picasso-doramaar': { description: `朵拉·瑪爾肖像的多視角面孔與心理色彩已被應用。\n正面與側面並存於一張臉上；色彩表達情緒狀態而非真實面貌。\n\n不對稱的眼睛、偏移的鼻子、不齊的嘴，以心理強度構建立體派肖像。\n在一張臉中融合立體派解構與情感探索的綜合體。` },
  ...
  'lichtenstein-inthecar': { description: `In the Car的細膩本戴點與電影式取景已被應用。\n如電影畫面般的特寫展示兩張臉；點狀技法創造膚色的陰影與色調。\n\n男人與女人看著同一方向卻沒有對視；無聲的張力比言語更能說話。\n漫畫浪漫成為對溝通無能的反思的普普藝術精髓。` },
