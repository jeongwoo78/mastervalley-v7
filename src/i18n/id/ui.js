...
export const ui = {
  ...
  category: {
    ...
    westernArtDesc: 'Perjalanan 2500 tahun seni barat',
  ...
  photoStyle: {
    ...
    movementsFullTitle: 'Perjalanan seni 2500 tahun',
    ...
    orientalFullDesc: 'Korea · Cina · Jepang',
    ...
    baroque: 'Barok',
    rococo: 'Rokoko',
    neoRomanReal: 'Neoklasik·Roman·Realis',
  ...
  processing: {
    ...
    movementsSub2: '2500 tahun seni barat',
    ...
    orientalSub1: 'Korea · Cina · Jepang',
