...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'Coba lagi',
    retryConfirmBody: 'Coba lagi {n} transformasi yang gagal? (gratis)',
    retryConfirmAction: 'Coba lagi',
    retryCountExceeded: 'Batas percobaan terlampaui (maks. 3)',
    cancel: 'Batal',
