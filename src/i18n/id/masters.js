...
export const mastersBasicInfo = {
  ...
  'lichtenstein': {
    ...
    result: {
      ...
      subtitle2: 'Mengubah komik menjadi seni',
      works: {
        'inthecar': { subtitle1: 'In the Car', subtitle2: 'Ketegangan diam, emosi berkecepatan tinggi' },
        'mmaybe': { subtitle1: 'M-Maybe', subtitle2: 'Satu kata keraguan, drama Pop Art' },
        'forgetit': { subtitle1: 'Forget It!', subtitle2: 'Jeritan perpisahan dalam satu panel komik' },
        'ohhhalright': { subtitle1: 'Ohhh...Alright...', subtitle2: 'Kepasrahan dan penerimaan dalam satu napas' },
        'stilllife': { subtitle1: 'Still Life with Crystal Bowl', subtitle2: 'Benda mati terlahir kembali lewat titik Ben-Day' }
      }
    }
  },
...
export const mastersLoadingEducation = {
  'vangogh': {
    name: 'Van Gogh', description: `Teknik impasto tebal dan sapuan kuas berputar telah diterapkan.
...
Bersama Braque, ia mengembangkan Kubisme—sebuah revolusi yang menghancurkan perspektif tradisional dan membuka pintu menuju seni abstrak.` },
  'frida': {
    name: 'Frida Kahlo', description: `Warna folk Meksiko tradisional, dedaunan tropis, dan persekutuan dengan hewan telah diterapkan.
...
Portret ini, dengan latar biru berputar, dianggap sebagai puncak kemampuan teknisnya dan ekspresi batinnya.`
  ...
  'klimt-kiss': {
    description: `Latar belakang daun emas dan pola dekoratif geometris dari 〈The Kiss〉 telah diterapkan.
...
Ini adalah contoh sempurna dari Gesamtkunstwerk—karya seni total yang menyatukan lukisan, arsitektur, dan kerajinan.`
  ...
  'munch-scream': {
    description: `Kurva bergelombang dan bentuk terdistorsi dari 〈The Scream〉 telah diterapkan.
...
Kini menjadi simbol visual kecemasan modern yang paling diakui di dunia.`
  ...
  'munch-madonna': {
    description: `Halo merah dan kurva sensual bergelombang dari 〈Madonna〉 telah diterapkan.
...
Ini adalah meditasi tentang siklus abadi kehidupan yang hanya bisa diungkapkan Munch dengan keberanian seperti ini.`
  ...
  'matisse-redroom': {
    description: `Komposisi bidang warna datar yang menentang perspektif dalam 〈The Red Room〉 telah diterapkan.
...
Ini adalah bukti keberanian Matisse: bahwa warna bisa lebih kuat dari realitas.`
  ...
  'picasso-doramaar': {
    description: `Tampilan depan dan samping secara bersamaan dari 〈Portrait of Dora Maar〉 telah diterapkan.
...
Picasso kemudian berkata: 'Dora, untuk saya, selalu menangis.' Lukisan ini adalah monumen untuk kecerdasan dan penderitaannya.`
  ...
  'lichtenstein-inthecar': {
    description: `Titik Ben-Day dan kontur hitam tebal dari 〈In the Car〉 telah diterapkan.
