...
export const mastersBasicInfo = {
  ...
  'vangogh-selfportrait': { result: { name: 'Vincent van Gogh (1853–1890)', subtitle1: 'Potret Diri (Self-Portrait)', subtitle2: 'Tatapan paling jujur di dunia' } },
  'klimt-kiss': { result: { name: 'Gustav Klimt (1862–1918)', subtitle1: 'Ciuman (The Kiss)', subtitle2: 'Cinta terbalut emas' } },
  'klimt-judith': { result: { name: 'Gustav Klimt (1862–1918)', subtitle1: 'Judith I (Judith I)', subtitle2: 'Rayuan dan kekuasaan' } },
  'klimt-treeoflife': { result: { name: 'Gustav Klimt (1862–1918)', subtitle1: 'Pohon Kehidupan (The Tree of Life)', subtitle2: 'Spiral keabadian' } },
  'munch-scream': { result: { name: 'Edvard Munch (1863–1944)', subtitle1: 'Jeritan (The Scream)', subtitle2: 'Kecemasan yang menjadi gambar' } },
  'munch-madonna': { result: { name: 'Edvard Munch (1863–1944)', subtitle1: 'Madonna (Madonna)', subtitle2: 'Di mana kesucian dan sensualitas bertemu' } },
  'munch-puberty': { result: { name: 'Edvard Munch (1863–1944)', subtitle1: 'Pubertas (Puberty)', subtitle2: 'Kegelisahan kepolosan' } },
  'matisse-dance': { result: { name: 'Henri Matisse (1869–1954)', subtitle1: 'Tarian (The Dance)', subtitle2: 'Ritme primordial tubuh' } },
  'matisse-redroom': { result: { name: 'Henri Matisse (1869–1954)', subtitle1: 'Kamar Merah (The Red Room)', subtitle2: 'Dunia yang digenangi merah' } },
  'matisse-hat': { result: { name: 'Henri Matisse (1869–1954)', subtitle1: 'Wanita Bertopi (Woman with a Hat)', subtitle2: 'Tembakan pembuka Fauvisme' } },
  'chagall-overthecity': { result: { name: 'Marc Chagall (1887–1985)', subtitle1: 'Di Atas Kota (Over the Town)', subtitle2: 'Terbang di atas kota bersama kekasih' } },
  'chagall-iandthevillage': { result: { name: 'Marc Chagall (1887–1985)', subtitle1: 'Aku dan Desa (I and the Village)', subtitle2: 'Nostalgia kampung halaman dalam mimpi' } },
  'chagall-bouquet': { result: { name: 'Marc Chagall (1887–1985)', subtitle1: 'Buket dengan Kekasih Terbang (Bouquet with Flying Lovers)', subtitle2: 'Bunga yang mekar dalam cinta' } },
  'picasso-demoiselles': { result: { name: 'Pablo Picasso (1881–1973)', subtitle1: 'Les Demoiselles d\'Avignon (Les Demoiselles d\'Avignon)', subtitle2: 'Detonasi Kubisme' } },
  'picasso-guernica': { result: { name: 'Pablo Picasso (1881–1973)', subtitle1: 'Guernica (Guernica)', subtitle2: 'Jeritan menentang perang' } },
  'picasso-doramaar': { result: { name: 'Pablo Picasso (1881–1973)', subtitle1: 'Potret Dora Maar (Portrait of Dora Maar)', subtitle2: 'Depan dan samping dalam satu wajah' } },
  'frida-brokencolumn': { result: { name: 'Frida Kahlo (1907–1954)', subtitle1: 'Kolom Patah (The Broken Column)', subtitle2: 'Tubuh terbuka, jiwa tak tergoyahkan' } },
  'frida-thornnecklace': { result: { name: 'Frida Kahlo (1907–1954)', subtitle1: 'Potret Diri dengan Kalung Duri dan Kolibri (Self-Portrait with Thorn Necklace and Hummingbird)', subtitle2: 'Rasa sakit sebagai mahkota' } },
  'frida-twofridaskahlo': { result: { name: 'Frida Kahlo (1907–1954)', subtitle1: 'Dua Frida (The Two Fridas)', subtitle2: 'Dua hati, satu Frida' } },
  'lichtenstein-drowninggirl': { result: { name: 'Roy Lichtenstein (1923–1997)', subtitle1: 'Drowning Girl (Drowning Girl)', subtitle2: 'Drama komik di atas kanvas' } },
  'lichtenstein-whaam': { result: { name: 'Roy Lichtenstein (1923–1997)', subtitle1: 'Whaam! (Whaam!)', subtitle2: 'Ledakan komik sebagai seni' } },
  'lichtenstein-inthecar': { result: { name: 'Roy Lichtenstein (1923–1997)', subtitle1: 'In the Car (In the Car)', subtitle2: 'Momen beku dari komik' } }
};
...
Lukisan ini mempertanyakan: apakah kita benar-benar terhubung, atau hanya gambar dari koneksi?` },
  ...
  'munch_default': { description: `Gaya ekspresionis Munch dengan warna mengganggu dan bentuk bergelombang telah diterapkan.\nGaris sinuosa dan nada pucat menyampaikan kecemasan psikologis secara langsung.\n\nLanskap yang terdistorsi mengikuti ritme emosi internal, di mana tidak ada yang stabil.\nBahasa visual kecemasan, pelopor dalam mengubah isi jiwa menjadi gambar.` },
  'matisse_default': { description: `Gaya fauvis Matisse dengan warna murni dan bentuk sederhana telah diterapkan.\nWarna primer berani disusun tanpa menghormati kenyataan, dan bentuk direduksi ke esensi.\n\nGaris menjadi tarian dan warna menjadi musik — setiap elemen bernyanyi dengan kemandiriannya.\nSeni kegembiraan murni, di mana warna bebas dari segala kewajiban deskriptif.` },
  'chagall_default': { description: `Gaya mimpi Chagall dengan warna pastel dan figur melayang telah diterapkan.\nKekasih, hewan, dan atap melayang dalam ruang tanpa gravitasi, diwarnai nostalgia.\n\nMerah muda, ungu, dan biru melebur bagaikan kenangan yang berbaur dalam mimpi.\nDunia di mana cinta dan memori menantang hukum fisika dan waktu.` },
