...
export const ui = {
  ...
  category: {
    ...
    westernArtDesc: 'رحلة 2500 عام من الفن الغربي',
  ...
  photoStyle: {
    ...
    movementsFullTitle: 'رحلة فنية لـ 2500 عام',
    ...
    orientalFullDesc: 'كوريا · الصين · اليابان',
