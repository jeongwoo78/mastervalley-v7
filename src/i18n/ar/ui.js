...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'إعادة المحاولة',
    retryConfirmBody: 'إعادة محاولة {n} تحويلات فاشلة؟ (مجاناً)',
    retryConfirmAction: 'إعادة المحاولة',
    retryCountExceeded: 'تم تجاوز حد إعادة المحاولة (بحد أقصى 3 مرات)',
    cancel: 'إلغاء',
