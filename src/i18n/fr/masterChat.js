...
export const masterChat = {
  ...
  // ===== Noms des maîtres (7) =====
  masterNames: {
    'VAN GOGH': "Je suis Van Gogh, d'Arles. J'ai peint votre photo dans mon style. Qu'en pensez-vous ?",
    'KLIMT': "Je suis Klimt, de Vienne. J'ai peint votre photo sur ma toile. Qu'en pensez-vous ?",
    'MUNCH': "Je suis Munch, d'Oslo. J'ai peint votre photo dans mon style. Qu'en pensez-vous ?",
    'CHAGALL': "Je suis Chagall, de Vitebsk. J'ai peint votre photo avec mes couleurs. Qu'en pensez-vous ?",
    'MATISSE': "Je suis Matisse, de Nice. J'ai rempli votre photo de ma palette. Qu'en pensez-vous ?",
    'FRIDA': "Je suis Frida, du Mexique. J'ai peint votre photo dans mon style. Qu'en pensez-vous ?",
    'LICHTENSTEIN': "Je suis Lichtenstein, de New York. J'ai peint votre photo dans mon style. Qu'en pensez-vous ?"
  },
