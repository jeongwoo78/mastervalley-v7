...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'Réessayer',
    retryConfirmBody: 'Relancer {n} transformations échouées ? (gratuit)',
    retryConfirmAction: 'Réessayer',
    retryCountExceeded: 'Limite de tentatives atteinte (max 3)',
    cancel: 'Annuler',
    ...
    loadingEducationFallback: "L'histoire de cette œuvre sera bientôt disponible.",
