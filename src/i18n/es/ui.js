...
export const ui = {
  ...
  result: {
    ...
    retryConfirmTitle: 'Reintentar',
    retryConfirmBody: '¿Reintentar {n} transformaciones fallidas? (gratis)',
    retryConfirmAction: 'Reintentar',
    retryCountExceeded: 'Límite de reintentos superado (máx. 3)',
    cancel: 'Cancelar',
