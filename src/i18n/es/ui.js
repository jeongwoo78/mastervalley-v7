...
export const ui = {
  // ===== CategorySelection =====
  category: {
    westernArt: 'Historia del Arte Occidental',
    westernArtDesc: 'Un viaje por 2800 años de arte occidental',
  ...
  photoStyle: {
    ...
    movementsFullTransformLabel: 'Los 11 movimientos',
    mastersFullTransformLabel: 'Los 7 maestros',
    orientalFullTransformLabel: 'Todo el arte oriental',
    movementsFullTitle: 'Viaje por 2800 años de arte',
    movementsFullDesc: '11 movimientos',
    mastersFullTitle: 'El mundo de 7 maestros',
    mastersFullDesc: 'Encuentro con 7 maestros',
    orientalFullTitle: 'Estética oriental milenaria',
    orientalFullDesc: 'China · Japón · Corea',
    perTransform: 'conversión',
    selectMovement: 'Selecciona un movimiento',
    selectMaster: 'Selecciona un maestro',
    mastersGalleryDesc: 'Obras reales transformadas en 7 estilos de maestros por Master Valley',
    selectStyle: 'Selecciona un estilo',
    grecoRoman: 'Grecia-Roma',
    medieval: 'Medieval',
    renaissance: 'Renacimiento',
    baroque: 'Barroco',
    rococo: 'Rococó',
    neoRomanReal: 'Neoclás. · Román. · Realismo',
    impressionism: 'Impresionismo',
    postImpressionism: 'Postimpresionismo',
    fauvism: 'Fauvismo',
    ...
    chinese: 'Pintura china',
    japanese: 'Pintura japonesa',
    koreanSub: 'Minhwa · Pungsokdo',
    chineseSub: 'Tinta · Gongbi',
    japaneseSub: 'Ukiyo-e · Rinpa',
    artNotice: 'Debido a la naturaleza de las obras maestras originales, algunos estilos pueden incluir desnudo artístico.',
    nudeWarningSingle: 'El desnudo artístico de la obra original puede reflejarse en el resultado.',
    nudeWarningOneclick: 'Algunos resultados pueden reflejar desnudo artístico de las obras originales.',
  ...
  processing: {
    ...
    masterInProgress: 'maestro en proceso...',
    checkingArtwork: 'Verificando obra...',
    done: '¡Listo!',
    movementsComplete: 'movimientos maestros completados!',
    mastersComplete: 'maestros completados!',
    nationsComplete: 'naciones maestros completados!',
    fullTransform: '✨ Transformación completa',
    ...
    doneLabel: 'trabajo completado',
    masterDoneLabel: 'trabajo del maestro completado',
    movementsLabel: ' movimientos',
    mastersLabel: ' maestros',
    nationsLabel: ' estilos orientales',
    movementsSub1: 'De la Antigua Grecia al Modernismo',
    movementsSub2: '2800 años de arte occidental',
    mastersSub1: 'Pintores que redibujaron el mundo a su manera',
    mastersSub2: 'Cuestionar, romper, reconstruir',
    orientalSub1: 'China · Japón · Corea',
    orientalSub2: 'Tres estéticas distintas, una misma alma',
    prev: '◀ Anterior',
    next: 'Siguiente ▶',
  ...
  result: {
    ...
    conversionFailed: 'La transformación ha fallado.',
    aiRetrying: 'El maestro está retocando la obra...',
    refreshButton: 'Actualizar',
    refreshFailed: 'No se pudo cargar el resultado',
    refreshing: 'Cargando...',
    refreshInProgress: 'Aún procesando. Inténtalo de nuevo en un momento.',
    retryLimitExceeded: 'Límite de reintentos superado (máx. 3)',
    retryServerError: 'Error del servidor durante el reintento. Contacta con soporte.',
    retryUnauthorized: 'Reintento no autorizado.',
    ...
    shareArt: 'Compartir',
    original: 'Original',
    tapToSwipe: '← Desliza para ver el resultado →',
    hide: 'Ocultar',
    show: 'Ver',
  ...
  gallery: {
    ...
    saved: 'Guardado',
    empty: 'Aún no hay imágenes guardadas',
    emptySubtext: 'Las imágenes transformadas se guardan aquí automáticamente',
    ...
    back: 'Atrás',
    home: 'Inicio',
    deviceNote: 'Las imágenes se guardan en tu dispositivo.',
    countUnit: '',
    delete: 'Eliminar',
    saveToDevice: 'Guardar',
    shareArt: 'Compartir',
    ...
    cancel: 'Cancelar',
    confirmDeleteSelected: '¿Eliminar {count} imagen(es) seleccionada(s)?',
    selectedCount: '{count} seleccionada(s)',
    saving: 'Guardando...',
    batchSaveComplete: '¡{count} imágenes guardadas!',
    batchSavePartial: '{success} guardadas, {fail} fallidas'
  },
  ...
  // ===== AI Consent =====
  aiConsent: {
    message: 'Tu foto se enviará a proveedores de IA de terceros confiables para su transformación y no se conservará después del procesamiento. Consulta nuestra Política de Privacidad para más detalles.',
    confirm: 'Aceptar'
  },
  ...
  addFunds: {
    ...
    get: 'Aplicar',
    bonusLabel: 'Bonus',
    tagStarter: 'Comienza tu viaje en el tiempo',
  ...
  // ===== Subscription Info =====
  subscriptionInfo: {
    line1: 'No necesitas suscripción',
    line2: 'Paga solo cuando lo necesites'
  },

  // ===== InsufficientBalance =====
  insufficientBalance: {
    title: 'Saldo insuficiente',
    requires: 'Coste de esta transformación:',
    yourBalance: 'Tu saldo actual:',
    recommended: 'Recomendado',
    addFundsNow: 'Recargar ahora',
  ...
  language: {
    ...
    googleFailed: 'Error al iniciar con Google',
    appleFailed: 'Error al iniciar con Apple',
    ...
    resetEmailPrompt: 'Ingresa tu correo para recibir un enlace de restablecimiento',
    resetEmailSent: 'Correo de restablecimiento enviado. Revisa tu bandeja de entrada.',
    resetEmailRequired: 'Por favor, ingresa tu correo primero',
    resetEmailFailed: 'Error al enviar correo de restablecimiento',
    // Developer message
    devMsg1: 'Soy el desarrollador de Master Valley — y su primer usuario.',
    devMsg2: 'Los artistas del Renacimiento rompieron mil años de tradición centrada en Dios y restauraron los ideales de la humanidad.',
    devMsg3: 'Cuando pasó la revolución y llegó la cámara, la cámara preguntó:',
    devMsg4: '"¿Qué pintar ahora?"',
    devMsg5: 'Algunos respondieron con luz, otros con color, otros con emoción y una nueva forma de ver.',
    devMsgHi1: 'Ahora la IA nos hace la misma pregunta.',
