...
export const MASTERS = {
  'vangogh-master': {
    ...
    quote: '나는 내 작품에 심장과 영혼을 담는다.',
    quoteEn: 'I put my heart and soul into my work.',
    origin: '네덜란드 · 후기인상주의',
    originEn: 'Netherlands · Post-Impressionism',
    icon: '🌻',
  ...
  'klimt-master': {
    ...
    quote: '시대에는 예술을, 예술에는 자유를.',
    quoteEn: 'To every age its art, to every art its freedom.',
    origin: '오스트리아 · 아르누보',
  ...
  'munch-master': {
    ...
    quote: '나는 보이는 것이 아니라 본 것을 그린다.',
    quoteEn: 'I paint not what I see, but what I saw.',
    origin: '노르웨이 · 표현주의',
    originEn: 'Norway · Expressionism',
    icon: '😱',
  ...
  'matisse-master': {
    ...
    quote: '색채의 목적은 형태가 아니라 감정을 표현하는 것이다.',
    quoteEn: 'The purpose of color is not to describe form but to express emotion.',
    origin: '프랑스 · 야수파',
    originEn: 'France · Fauvism',
    icon: '💃',
  ...
  'chagall-master': {
    ...
    quote: '우리 삶에는 단 하나의 색이 있다. 사랑의 색이다.',
    quoteEn: 'In our life there is a single color — the color of love.',
    origin: '러시아-프랑스 · 초현실주의',
    originEn: 'Russia-France · Surrealism',
    icon: '🎻',
  ...
  'frida-master': {
    ...
    quote: '발이 있으면 뭐 하나, 날개가 있는데.',
    quoteEn: 'Feet, what do I need them for if I have wings to fly?',
    origin: '멕시코 · 초현실주의',
    originEn: 'Mexico · Surrealism',
    icon: '🦜',
  ...
  'lichtenstein-master': {
    ...
    quote: '나는 만화를 그리는 것이 아니라, 만화를 주제로 그림을 그린다.',
    quoteEn: "I don't draw comics, I paint pictures about comics.",
    origin: '미국 · 팝아트',
    originEn: 'USA · Pop Art',
    icon: '💥',
