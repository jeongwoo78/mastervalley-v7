...
const PhotoStyleScreen = ({ mainCategory, onBack, onSelect, onMenu, onAddFunds, onCategoryChange, userCredits = 0, creditsLoaded = false, lang = 'en' }) => {
  ...
  const categoryData = {
    movements: {
      ...
      fullTransformLabel: ps.movementsFullTransformLabel || 'Full 11 Movements Transform',
    ...
    masters: {
      ...
      fullTransformLabel: ps.mastersFullTransformLabel || 'Full 7 Masters Transform',
    ...
    oriental: (() => {
      ...
      return {
        ...
        fullTransformLabel: ps.orientalFullTransformLabel || 'Full Oriental Transform',
