...
export const MODERNISM_PROMPTS = {
  ...
  'picasso-doramaar': {
    ...
    prompt: `Hand-painted oil painting of the subject by Pablo Picasso. The nose is seen from the side while the eyes face forward, thick, aggressive black contour lines divide the face into angular geometric planes. Vibrant primary colors fill each flat plane. Multiple viewpoints merge onto one surface. Edges between color planes are defined by bold black contour lines of varying thickness. Intense primary colors split into geometric planes. Vermilion red 25%, chrome yellow 25%, emerald green 25%, cobalt blue 25%. Simple color fields fill the background flatly. One eye painted red the other green, forehead and cheeks and chin each divided into different colored geometric planes painted flat. Chrome yellow light rests flatly on bright planes of the face. Strong decisive black lines along geometric divisions of face and body. Strong light illuminates the face flatly from the front. Blue and green sink into dark planes and background. Red and yellow claim bright planes, green and blue remain in dark planes. Raw tense psychological intensity, revolutionary cubist energy.`
  },
