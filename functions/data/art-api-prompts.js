...
export const ANCIENT_MEDIEVAL_PROMPTS = {
 ...
 prompt: `Ancient Greek-Roman marble sculpture style. Pure white Carrara marble with smooth polished surface, carved stone texture. Subject's clothing transforms into classical draped toga or stola, covering chest and body. Style reference sculptures: Nike of Samothrace, Augustus of Prima Porta, Eirene, Pietà. Preserve original gender and body proportions. Pure white marble tone dominates entirely with only faint natural marble grain.`
 },
...
export const RENAISSANCE_PROMPTS = {
 ...
 prompt: `Subject's clothing transforms into elegant garments of this painting's era and style, covering chest and body. Tempera and oil mural of the subject by Leonardo da Vinci. Pigments mixed with egg and oil applied in thin layers on dry plaster over a white ground. The surface has a matte chalky quality. Heavy dark brown presses down across the scene. Dark brown 35%, deep blue 25%, crimson red 20%, ivory 20%. Deep perspective stone hall stretches toward a central vanishing point. Skin emerges softly from darkness in warm amber and ivory, outlines vanish as edges dissolve like smoke. Bright light pours through the window behind the central figure. Deep dark brown settles heavily across the ceiling and walls, forms fade softly at their boundaries. Red and blue garments alternate among figures within the dark architectural space.`
 },
 ...
 prompt: `Subject's clothing transforms into elegant garments of this painting's era and style, covering chest and body. Buon fresco of the subject by Michelangelo. Pigments are pressed firmly into fresh wet plaster. Strong bold contours define every form with sculptural weight. The surface is matte and chalky like dried plaster. Edges between forms cut crisp and solid like carved stone. Warm apricot light glows under a vast open sky. Warm apricot 35%, soft grey 25%, olive green 20%, ivory 20%. Vast open sky leaves the space empty and expansive. Skin shines solid and sculptural in warm apricot and ivory. Light concentrates on the highest points of the form. Brushwork flows powerfully along the curves of the body. Soft even light reveals the forms throughout. Soft grey creates gentle shadows beneath the forms. Warm flesh rises vividly against the empty open sky.`
 },
...
export const ORIENTAL_PROMPTS = {
 ...
 prompt: `Korean folk painting (Minhwa) style from late Joseon Dynasty. MINERAL PIGMENTS on WARM YELLOWED HANJI PAPER with visible fiber texture. BOLD VIBRANT Obangsaek colors (red, blue, yellow, white, black) applied in LAYERS from light to dark. Various brush sizes creating different textures and lines. SIMPLIFIED EXAGGERATED FORMS with humor and naive charm. SYMBOLIC MOTIFS: tigers and magpies , peonies , cranes, carp, ten longevity symbols. Unconventional compositions filling entire surface. Primitive folk art quality. Traditional Korean hanbok clothing covering chest and body if people present. Skin painted in warm ochre and earth tones. Natural unadorned beauty - warm approachable charm with innocent smile.`
 },
