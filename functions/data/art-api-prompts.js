...
export const RENAISSANCE_PROMPTS = {
  ...
  'leonardo-lastsupper': {
    ...
    prompt: `Subject MUST wear elegant period-appropriate clothing covering chest and body. Tempera and oil mural of the subject by Leonardo da Vinci. Pigments mixed with egg and oil applied in thin layers on dry plaster over a white ground. The surface has a matte chalky quality. Heavy dark brown presses down across the scene. Dark brown 35%, deep blue 25%, crimson red 20%, ivory 20%. Deep perspective stone hall stretches toward a central vanishing point. Skin emerges softly from darkness in warm amber and ivory, outlines vanish as edges dissolve like smoke. Bright light pours through the window behind the central figure. Deep dark brown settles heavily across the ceiling and walls, forms fade softly at their boundaries. Red and blue garments alternate among figures within the dark architectural space.`
  },
...
export const ORIENTAL_PROMPTS = {
  ...
  'gongbi': {
    ...
    prompt: `Chinese meticulous court painting (Gongbi/工筆) style from Tang/Song Dynasty. FINE PRECISE INK OUTLINES drawn first, then COLOR WASHES applied LAYER BY LAYER from lightest to darkest building rich depth and volume. NATURAL MINERAL PIGMENTS on SILK with visible woven texture and LUMINOUS SUBTLE SHEEN throughout. Rich vivid saturated colors - vermillion (朱砂), malachite green (石綠), azurite blue (石青), gold leaf. ULTRA-FINE DETAILED BRUSHWORK - every eyelash and hair strand individually painted with hair-thin lines. Tang/Song Dynasty imperial court elegance. RICHLY FILLED composition with elaborate background elements. Elaborate decorative patterns on robes, ornate jade hair ornaments, gold jewelry, embroidered silk details. Regal dignified beauty with serene majestic bearing - imperial court splendor. Traditional Chinese hanfu clothing covering chest and body with LAVISH ornate details and layered textures. Skin painted in warm ochre and earth toned mineral pigments.`
  },
...
export const ARTIST_STYLES = {
  ...
  'boucher': 'Old oil painting by François Boucher, Boucher art style, soft rosy flesh tones, light pastel palette, playful decorative elegance.',
  ...
  'cezanne': 'Old oil painting by Paul Cézanne, Cézanne art style, geometric structural forms, visible constructive brushstrokes, muted earthy palette.',
  ...
  'derain': 'Old oil painting by André Derain, Derain art style, explosive vivid colors, bold rough brushstrokes, raw fauvist energy.',
  ...
  'magritte': 'Old oil painting by René Magritte, Magritte Surrealist art style, philosophical visual paradox, mysterious object obscuring face, dreamlike impossible scenarios.',
  'miro': 'Old oil painting by Joan Miró, Miró art style, playful biomorphic shapes, childlike symbols floating, primary colors on white background, spontaneous whimsical lines.',
...
2. "Portrait of Adele Bloch-Bauer I" → FEMALE, elegant, iconic | Style: gold throne, diamond choker, geometric patterns
