...
export const EXPRESSIONISM_PROMPTS = {
  ...
  'munch-madonna': {
    name: '마돈나',
    nameEn: 'Madonna',
    prompt: `Original clothing from photo covers chest fully. Preserve mysterious evocative mood with closed eyes and flowing dark hair. Hand-painted oil painting of the subject by Edvard Munch. Wavy distorted lines swirl across the entire surface, trembling with rough unstable thick brushmarks full of dark psychological intensity. Outlines ripple and twist as edges warp into wavy distorted lines. A dark red aura wraps around the figure with dark mysterious atmosphere. Deep black 40%, dark navy blue 25%, ivory 20%, crimson red 15%. Deep black fills the background with oppressive void. Face and skin crudely distorted with naïve primitive features, the face elongates into a pale glowing oval of sickly ivory with a feverish reddish flush. Red aura light radiates outward around the hair. Rough thick brushwork spreads outward following the undulating flow of the hair. Deep red light radiates from inside the figure outward with inner torment. Deep black sinks into the background and deep within the hair. Ivory claims the skin with crimson claiming the aura and dark navy blue claiming the background.`
  },
...
export const ARTIST_STYLES = {
  ...
  'gongbi': 'Exquisite Chinese meticulous court painting (Gongbi). FINE DETAILED BRUSHWORK with precise outlines. MINERAL PIGMENTS on silk with subtle sheen and VISIBLE SILK TEXTURE. Rich vivid colors — vermillion, malachite green, azurite blue, gold. Tang/Song Dynasty imperial court elegance. Clothing MUST be traditional Chinese hanfu (flowing dress for women, scholar robe for men). Skin in warm ochre and earth toned pigments.',
  'ukiyoe': 'Stunning Japanese Ukiyo-e woodblock print style. FLAT COLOR AREAS with BOLD BLACK OUTLINES. LIMITED COLOR PALETTE of traditional woodblock inks. WOODGRAIN TEXTURE visible in color areas. Stylized figures with distinctive features. Floating world aesthetic. Clothing MUST be traditional Japanese attire (kimono for women, hakama with haori for men).',
