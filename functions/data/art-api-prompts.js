...
export const ANCIENT_MEDIEVAL_PROMPTS = {
  ...
  'marble': {
    ...
    prompt: `Ancient Greek-Roman marble sculpture style. Pure white Carrara marble with smooth polished surface, carved stone texture. Subject wears classical draped toga or stola. Style reference sculptures: Nike of Samothrace, Augustus of Prima Porta, Eirene, Pietà. Preserve original gender and body proportions. Pure white marble tone dominates entirely with only faint natural marble grain.`
  },
...
export const RENAISSANCE_PROMPTS = {
  ...
  'michelangelo-adam': {
    ...
    prompt: `Subject MUST wear elegant period-appropriate clothing covering chest and body. Buon fresco of the subject by Michelangelo. Pigments are pressed firmly into fresh wet plaster. Strong bold contours define every form with sculptural weight. The surface is matte and chalky like dried plaster. Edges between forms cut crisp and solid like carved stone. Warm apricot light glows under a vast open sky. Warm apricot 35%, soft grey 25%, olive green 20%, ivory 20%. Vast open sky leaves the space empty and expansive. Skin shines solid and sculptural in warm apricot and ivory. Light concentrates on the highest points of the form. Brushwork flows powerfully along the curves of the body. Soft even light reveals the forms throughout. Soft grey creates gentle shadows beneath the forms. Warm flesh rises vividly against the empty open sky.`
  },
...
export const ARTIST_STYLES = {
  ...
  // 🏛️ 신고전주의
  'david': 'Old oil painting by Jacques-Louis David, Subject MUST wear elegant clothing covering chest and body, David art style, crisp clear outlines, heroic idealized figures, dramatic moral intensity.',
  ...
  // ⭐ 거장 전용
  'klimt': 'by Gustav Klimt, Klimt art style, Subject MUST wear elegant clothing covering chest and body, ornate gold leaf patterns, intricate decorative mosaic, flat Byzantine-inspired figures, jewel-like embedded details, geometric robes with spirals and rectangles.',
